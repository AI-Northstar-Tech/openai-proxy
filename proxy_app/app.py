...
parser.add_argument(
    "-t", "--db_type", type=str, help="Database Type, for eg.: postgresql"
)
parser.add_argument(
    "-m", "--db_module", type=str, help="Database Module, for eg.: psycopg2"
)
...
parser.add_argument(
    "-n", "--admin", type=str, help="Admin Username for the Proxy Server"
)
parser.add_argument(
    "-s", "--admin_pass", type=str, help="Admin Password for the Proxy Server"
)
