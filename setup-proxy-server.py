...
parser.add_argument("-a", "--openai_api_key", type=str, help="OpenAI API Key")
parser.add_argument(
...
if args.openai_api_key is None:
    args.openai_api_key = getpass.getpass(prompt="Enter OpenAI API Key: ", stream=None)
...
if args.proxy_server_pass is None:
    args.proxy_server_pass = getpass.getpass(prompt="Enter Admin Password: ", stream=None)
